        ...
        <div className="container-fluid " style={ { backgroundColor: 'black', height: '100vh' } } >
            <div className="row p-5" style={ { marginBottom: '477px' } }>
                ...
                <div className="col-md-6">
                    { state ? <div className="card card-body alert alert-danger"><center>Sorry! Please consult DOCTOR.</center></div>
                    : <div className="card card-body alert alert-success"><center>Great! You are HEALTHY.</center></div>
                    }
                    <div className="row">
