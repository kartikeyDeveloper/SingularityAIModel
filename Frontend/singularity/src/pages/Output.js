    ...
    return (
        <div className="container-fluid " style={ { backgroundColor: 'black', height: '100vh' } } >
            <div class="row p-5" style={ { marginBottom: '477px' } }>
                ...
                <div class="col-md-6">
                    {state !=0 &&<div class="card card-body alert alert-danger"><center>Sorry! Please consult DOCTOR.</center></div>
}
                   {state==0 && <div class="card card-body alert alert-success"><center>Great! You are HEALTHY.</center></div>
}
                    <div class="row">
